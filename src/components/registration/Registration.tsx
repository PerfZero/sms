  ...
  return (
    <div className="registration">
      ...
      <div className="registration__content">
          ...
          <img src="images/dots.svg" alt="" />
            ...
            <div className="registration__form">
              ...
              <div className="registration__login-link">
                <a href="/login">Вход с аккаунтом Atlas</a>
              </div>
              <button 
        ...
        {step === 'success' && (
          <>
            <h1 className="registration__title">Ваш аккаунт Atlas успешно создан!</h1>
            <div className="registration__success">
              ...
              <button className="registration__button" onClick={() => navigate('/dashboard')}>
                Начать копить
              </button>
            </div>
          </>
